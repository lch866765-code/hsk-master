...
SRS(간격 반복) 방식으로 HSK 3.0 신 HSK 3–6급 중국어 단어를 효율적으로 암기하는 PWA 앱입니다.

---

## 🆕 최신 업데이트 (2026년 4월)

- 📖 **신 HSK 3.0 단어** — 총 1,200개 (HSK 3·4·5·6급 각 300개, 계속 확장 중)
- 🏷️ **품사 표시 및 필터** — 명사·동사·형용사 등 색깔 배지, 설정에서 품사별 학습 가능
- 📝 **모의시험 모드** — 객관식·받아쓰기·혼합, 점수 확인 및 틀린 단어 복습
...
**주요 기능:**
- 📖 **신 HSK 3.0 단어** (HSK 3–6급, 총 1,200개 수록, 계속 확장 중)
- 🧠 4단계 평가 (다시/어려움/좋음/쉬움) SRS 알고리즘
- 🔊 중국어 발음 자동 재생
- 🏷️ **품사 표시** — 카드에 명사/동사/형용사 등 색깔 배지 표시
- 🔍 **품사별 필터** — 설정에서 원하는 품사만 학습
- 📝 **모의시험** — 객관식 · 받아쓰기 · 혼합 모드, 결과 분석
- 📊 학습 통계 및 진행도 확인
- 🌙 다크 모드 지원
- 📲 PWA — 홈 화면에 앱처럼 설치 가능
