  ...
  return (
    <div className="flip-card w-full h-72 cursor-pointer" onClick={handleFlip}>
      <div className={`flip-card-inner w-full h-full ${isFlipped ? 'flip-card-inner-flipped' : ''}`}>
        {/* Front */}
        <div className="flip-card-face bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center border border-gray-100 dark:border-gray-700">
        ...
        {/* Back */}
        <div className="flip-card-face flip-card-back-face bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center border border-gray-100 dark:border-gray-700">
